...
class KotlinToResolvedCallTransformer(
    ...
    fun updateRecordedType(
        ...
        dataFlowAnalyzer.checkType(updatedType, deparenthesized, context, !performFullTypeCheck)
    ...
    private fun reportCallDiagnostic(
        ...
        additionalDiagnosticReporter.reportAdditionalDiagnostics(completedCallAtom, resultingDescriptor, diagnosticHolder, context.languageVersionSettings)
