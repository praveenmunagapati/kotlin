...
fun random() = if (exception) throw java.lang.RuntimeException() else false
...
fun box(): String {
    ...
    if (message != "Exception java.lang.RuntimeException; Finally block" ) return "fail 4: $message"
